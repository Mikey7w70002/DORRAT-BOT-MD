...
global.owner = [
  ['+5493815062090', '🔰  Mikey7w7- Creador 🔰', true],
  ['×××××××××', '🔰  ××××× - Collaborator 1 🔰', true],
  ['×××××××××', '🔰  ×××× - Collaborator 3 🔰', true],
  ['×××××××××', '🔰  ×××× -  Col𝚊𝚋𝚘𝚛𝚊𝚍𝚘𝚛  4 🔰', true],
  ['×××××××××', '🔰 ××××× - Col𝚊𝚋𝚘𝚛𝚊𝚍𝚘𝚛𝚊 5 🔰', true],
...
//------------- Sticker WM -----------
global.packname = '(☞ﾟ∀ﾟ)☞'
global.author = 'Mikey7w7
global.wm = 'mikey | MaikyGOD
global.igfg = 'Mikey7w7
global.wait = '*[❗] Ƈᴀʀɢᴀɴᴅᴏ, ᴀɢᴜᴀʀᴅᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ...*'
//-------------------
global.md = 'https://chat.whatsapp.com/IksJhUrsnqzJZy6jsXrBx6'
global.dorramd = md
